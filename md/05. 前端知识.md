...
但是现在都是`webpack` 项目，可以用 `webpack-bundle-analyzer`插件分析项目中哪些部分
...
1. `Object.defineProperty` 无法监控到数组下标的变化，导致通过数组下标添加元素，不能实时响应；
    ...
    > `Object.defineProperty` 本身是可以监控到数组下标的变化的，但是在 `Vue` 中，从性能/体验的性价比考虑，尤大就弃用了这个特性。
